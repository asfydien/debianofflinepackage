...
#Web Server
apt install -d  -y apache2 perl ruby openssl python certbot libapache2-mod-auth-kerb apache2-utils php5
...
#Database Server
apt install -d -y mariadb-server mariadb-client mysql-server phpmyadmin
